...
def public_chef_detail(request, chef_id):
    ...
    chef_data = {
        ...
        'area': chef.area,
        'city': chef.city,
        'address_line1': chef.address_line1,
        'address_line2': chef.address_line2,
        'pincode': chef.pincode,
        'full_address': chef.full_address,
        'cuisine_specialties': chef.cuisine_specialties,
        'cooking_experience': chef.cooking_experience,
        'average_rating': float(chef.average_rating),
        'total_ratings': chef.total_reviews,
        'completed_orders': chef.total_orders_completed,
        'is_verified': chef.is_verified,
        'kitchen_type': chef.kitchen_type,
        'kitchen_address': chef.full_address,
